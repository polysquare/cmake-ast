...
_NODE_INFO_TABLE = {
    ...
    "WhileStatement": _node("while_stmnt", single=["header"], multi=["body"]),
    "ForeachStatement": _node("foreach", single=["header"], multi=["body"]),
    "FunctionDefinition": _node("function_def", single=["header"],
                                multi=["body"]),
    "MacroDefinition": _node("macro_def", single=["header"], multi=["body"]),
    "IfBlock": _node("if_block", single=["if_statement", "else_statement"],
